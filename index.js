class Calculator {
    ...
    updateDisplay() {
        this.data_Current_Operand.innerText = this.getDisplayNumber(
            this.currentOperand
        );
        if (this.operation != null) {
            this.data_Previous_Operand.innerText = `${this.getDisplayNumber(
        this.previousOperand
      )} ${this.operation}`;
        } else {
            this.data_Previous_Operand.innerText = "";
        }
    }
}
...
all_Clear.addEventListener("click", (button) => {
    calculator.clear();
    calculator.updateDisplay();
});
